<template>
    <div style="backgroundImage: url('/yimiaoyuyuexitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">疫苗预约网站系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="医院名称" class="input" v-if="tableName=='yiyuanxinxi'">
                            <el-input v-model="ruleForm.yiyuanxinxiName" autocomplete="off" placeholder="医院名称"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='yiyuanxinxi'">
                            <el-input v-model="ruleForm.yiyuanxinxiPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.yiyuanxinxiName)&& 'yiyuanxinxi'==this.tableName){
                                this.$message.error('医院名称不能为空');
                                return
                            }
                             if('yiyuanxinxi' == this.tableName && this.ruleForm.yiyuanxinxiPhone&&(!this.$validate.isMobile(this.ruleForm.yiyuanxinxiPhone))){
